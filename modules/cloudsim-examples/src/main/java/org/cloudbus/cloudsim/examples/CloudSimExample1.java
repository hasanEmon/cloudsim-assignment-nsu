...
//			for (int i = 0; i < mid; i++) {
//				rcList.add(randomPes.get(i));
//			}
//
//			Collections.sort(rcList, Collections.reverseOrder());
//
//			List<Integer> nrcList = new ArrayList<>();
//			for (int i = mid; i < randomPes.size(); i++) {
//				nrcList.add(randomPes.get(i));
//			}
//			Collections.sort(nrcList, Collections.reverseOrder());
//
//			randomPes.clear();
//
...
//			}
	...
	public static Datacenter createDatacenter(String name) {
		...
		int mips = CloudSimExampleInput1.hostCpuMips;
		int totalCpus = CloudSimExampleInput1.hostTotalCpus ;
		...
		// of machines
		int hostId = 0;
		int ram = CloudSimExampleInput1.hostTotalMem; // host memory (MB)
		long storage = CloudSimExampleInput1.hostTotalStorage; // host storage
		int bw = CloudSimExampleInput1.hostTotalBW;
